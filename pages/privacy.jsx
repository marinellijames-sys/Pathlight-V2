  ...
  return (
    <div className="min-h-screen bg-cream">
      <div className="max-w-3xl mx-auto px-6 py-16">
        <button
          onClick={() => router.back()}
          className="flex items-center gap-2 text-driftwood hover:text-charcoal mb-8 transition-medium"
        >
        ...
        <div className="card">
          <h1 className="text-4xl text-ink mb-2 font-serif">Privacy Policy</h1>
          <p className="text-sm text-driftwood mb-10">Last updated: January 2026</p>

          <div className="prose-kinfolk space-y-8">
            <section>
            ...
            <section>
              <h2 className="text-2xl text-ink mb-4 font-serif">How We Use Your Information</h2>
            ...
            <section>
              <h2 className="text-2xl text-ink mb-4 font-serif">How We Store Your Information</h2>
              <p>
            ...
            <section>
              ...
              <p className="mt-4">
                ...
                <a href="https://www.anthropic.com/privacy" className="text-sage-dark hover:text-sage underline underline-offset-2 transition-fast">
            ...
            <section>
              <h2 className="text-2xl text-ink mb-4 font-serif">Your Rights</h2>
            ...
            <section>
              <h2 className="text-2xl text-ink mb-4 font-serif">Data Security</h2>
              <p>
            ...
            <section>
              <h2 className="text-2xl text-ink mb-4 font-serif">Resume Upload (Paid Feature)</h2>
              <p>
            ...
            <section>
              <h2 className="text-2xl text-ink mb-4 font-serif">Changes to This Policy</h2>
              <p>
            ...
            <section>
              <h2 className="text-2xl text-ink mb-4 font-serif">Contact Us</h2>
              <p>
                If you have questions about this privacy policy or how we handle your data, please contact us at:{' '}
                <a href="mailto:marinellijames@gmail.com" className="text-sage-dark hover:text-sage underline underline-offset-2 transition-fast">
