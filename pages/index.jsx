...
const SECTIONS = [
  ...
  },
  {
    ...
    explainer: 'Energy is your compass. Think about work - what tasks or situations make you feel alive? But also look beyond work: hobbies, volunteering, daily activities. The more specific examples you share, the clearer the patterns.',
  ...
  },
  {
    ...
    explainer: 'People settle for work that doesn\'t fit their life. If you could design your perfect work setup - the role, schedule, environment, comp - what would it look like? Think about your hours, flexibility for kids or life, where you work, what you\'re doing, and what you need to feel secure. Go with the flow. Jot down everything - aim for 10+ things. No filter.',
    aiContext: 'capturing their ideal work setup and priorities'
  },
  {
    id: 'dealbreakers',
    title: 'Your Deal-Breakers',
    subtitle: 'What made you miserable',
    explainer: 'The best way to know what you DON\'T want is to look at what\'s made you miserable. Think about jobs, bosses, work environments that drained you. Don\'t hold back. List everything that made you dread Monday mornings - aim for at least 10 things. No filter, just let it flow. These aren\'t weaknesses, they\'re signals.',
...
export default function Pathlight() {
  ...
  const saveProgress = (newConversations, newSection, newAiCount, newScreener, newSynthesis, newPayment) => {
    try {
      localStorage.setItem('pathlight-progress', JSON.stringify({
        ...
        paymentCompleted: newPayment !== undefined ? newPayment : paymentCompleted,
  ...
  const sendMessage = async () => {
    ...
    // Brain dump sections: Skip AI entirely
    if (sectionId === 'unlimited' || sectionId === 'dealbreakers') {
      await saveProgress(newConversations, currentSection, aiResponseCount, screenerAnswers, synthesisGenerated);
      return;
    }
    
    // Check if we've hit max AI responses for this section
    ...
    try {
      // With MAX_AI_RESPONSES = 1, there's only one AI response per section
      
      let systemPrompt = `You are a warm, direct career coach helping someone discover their strengths.
...
${section.id === 'energy' ? `
You are responding to what they shared about what energizes them.

Your response should be 2-3 sentences:
1. Briefly acknowledge what they said
2. Ask ONE clarifying question that digs into the nuance

Examples:
- If they mention creating/building → "Is it the blank canvas or seeing it perform?"
- If they mention helping people → "Do you like the conversation or seeing them succeed later?"
- If they mention solving problems → "Is it the challenge or the resolution?"
- If they mention collaboration → "Is it the people connection or achieving together?"

Be conversational. This is a friend asking a thoughtful question, not an interview.

Keep it SHORT: 2-3 sentences maximum. No preamble, no summary.
` : ''}

${section.id === 'strengths' ? `
You are responding to what they shared about their strengths.

Your response should be 2-3 sentences:
1. Briefly acknowledge what they said  
2. Ask ONE question that clarifies the nuance

Examples:
- If they mention fixing/improving things → "Do you like making it better or teaching them how?"
- If they mention seeing solutions → "Is it the seeing itself or explaining it to others?"
- If they mention organizing/systems → "Is it creating the system or maintaining it?"
- If they mention connecting people → "Is it the matchmaking or watching it work?"

Conversational tone. Friend asking a thoughtful question.

2-3 sentences maximum. No preamble, no summary.
` : ''}

${section.id === 'wins' ? `
You are responding to an accomplishment they shared.

Your job: Make them feel their own power.

Ask ONE question that forces them to see themselves differently:

Examples:
- "What does that win say about who you ARE, not just what you did?"
- "Most people can't do that - what made YOU capable of it?"
- "When you think back on that moment - what surprised you most about yourself?"
- "What did pushing through that prove about you that you'd been doubting?"

Tone: Warm, powerful, certain. You're helping them own their capability.

2-3 sentences maximum. No preamble, no summary.
` : ''}

${section.id === 'unlimited' ? `
SPECIAL: This is a brain dump section. The user should not see any AI response.
If you see this, something is wrong - this section should have 0 AI responses.
` : ''}

${section.id === 'dealbreakers' ? `
SPECIAL: This is a brain dump section. The user should not see any AI response.
If you see this, something is wrong - this section should have 0 AI responses.
` : ''}

DO NOT:
- Give a summary or pattern identification
- Say "The more specific you are, the better I can identify patterns"
- Provide encouragement like "Great job" or "That's wonderful"
- Ask multiple questions

Just acknowledge what they said + ask one targeted follow-up question.
`;
...
CRITICAL: Generate EXACTLY 4 superpowers. Not 3, not 5. Exactly 4.

Identify 4 unique combinations of their strengths. Name each one distinctively and concretely.
          ...
          <div className="bg-white rounded-3xl p-8 shadow-xl space-y-5">
            <div className="text-center mb-4">
              <h2 className="text-2xl font-medium text-gray-900 mb-3">
                A Career Clarity Tool for Mid-Career Professionals
              </h2>
              <p className="text-sm text-gray-600 leading-relaxed">
                Pathlight is a strength discovery tool that helps you identify what you're naturally good at, 
                what energizes you, and which roles align with how you work best.
              </p>
            </div>
            ...
            <p className="text-base text-gray-700 leading-relaxed">
              You're here because something isn't quite right. Maybe you feel stuck. Maybe you lack direction. 
              Maybe you're ready for something different but don't know what.
            </p>
            <p className="text-base text-gray-700 leading-relaxed">
              This isn't about finding the perfect job title. It's about understanding what you want to 
              <span className="text-gray-900 font-medium"> do</span> every day, what energizes you, 
              and how to structure work around the life you want.
            </p>
            <p className="text-base text-gray-700 leading-relaxed">
              In the next 15 minutes, you'll discover your signature strengths, identify what to avoid, 
              and get specific pathways forward.
            </p>
          ...
          {!synthesisContent ? (
            <div className="bg-white rounded-3xl p-10 shadow-xl text-center">
              ...
              <p className="text-sm text-gray-500 mb-6">
                This takes 30-45 seconds. Please hold tight while we analyze your responses.
              </p>
              <button
            ...
            <>
              ...
              {synthesisScreen === 1 && parsedData?.superpowers && (
                <div className="space-y-8 animate-fade-in">
                  <div className="text-center mb-8">
                    ...
                    <h2 className="text-3xl font-medium text-gray-900 mb-2">Your Signature Strengths</h2>
                    <p className="text-gray-600">Here's a preview of what makes you uniquely valuable</p>
                  </div>

                  {/* FREE: Show only first Superpower */}
                  <div className="space-y-6">
                    <div className="bg-gradient-to-br from-pink-50 to-orange-50 rounded-3xl p-8 shadow-lg border-2 border-pink-200">
                      <div className="flex items-start gap-4">
                        ...
                        <div className="flex-1">
                          <h3 className="text-2xl font-medium text-gray-900 mb-3">{parsedData.superpowers[0].name}</h3>
                          <p className="text-gray-700 mb-4 leading-relaxed">{parsedData.superpowers[0].description}</p>
                    ...
                    {/* PAYMENT WALL - Only show if not paid */}
                    {!paymentCompleted && (
                      <>
                        {/* Locked Superpowers Preview */}
                        {[2, 3, 4].map((num) => (
                          <div key={num} className="bg-gray-100 rounded-3xl p-8 shadow-lg border-2 border-gray-300 relative overflow-hidden">
                            <div className="absolute inset-0 bg-gradient-to-br from-gray-200/50 to-gray-300/50 backdrop-blur-sm flex items-center justify-center">
                              <div className="text-center">
                                <div className="w-16 h-16 rounded-full bg-gray-400 flex items-center justify-center text-white text-2xl font-bold mx-auto mb-3">
                                  🔒
                                </div>
                                <p className="text-gray-600 font-medium">Signature Strength #{num}</p>
                              </div>
                            </div>
                            <div className="blur-sm">
                              <div className="flex items-start gap-4">
                                <div className="flex-shrink-0 w-12 h-12 rounded-full bg-gray-400 flex items-center justify-center text-white text-xl font-bold">
                                  {num}
                                </div>
                                <div className="flex-1">
                                  <h3 className="text-2xl font-medium text-gray-700 mb-3">Your Hidden Strength</h3>
                                  <p className="text-gray-600 mb-4 leading-relaxed">This strength is based on specific patterns we identified in your responses...</p>
                                </div>
                              </div>
                            </div>
                          </div>
                        ...
                        <div className="bg-gradient-to-br from-orange-50 to-amber-50 rounded-3xl p-10 shadow-xl border-2 border-orange-200 text-center">
                          <div className="inline-flex items-center justify-center w-20 h-20 rounded-full bg-gradient-to-br from-orange-400 to-amber-400 mb-6">
                            <Sparkles className="w-10 h-10 text-white" />
                          </div>
                          
                          <h3 className="text-3xl font-bold text-gray-900 mb-4">Unlock Your Complete Analysis</h3>
                          <p className="text-xl text-gray-700 mb-8 max-w-2xl mx-auto leading-relaxed">
                            You've seen one of your signature strengths. Get your complete career clarity package for <strong>$39</strong>.
                          </p>

                          <div className="bg-white rounded-2xl p-6 mb-8 text-left max-w-xl mx-auto">
                            <h4 className="font-semibold text-gray-900 mb-4 text-lg">Your complete analysis includes:</h4>
                            <ul className="space-y-3 text-gray-700">
                              <li className="flex items-start gap-3">
                                <Check className="w-5 h-5 text-green-500 flex-shrink-0 mt-0.5" />
                                <span><strong>3 Additional Signature Strengths</strong> uniquely named based on your responses</span>
                              </li>
                              <li className="flex items-start gap-3">
                                <Check className="w-5 h-5 text-green-500 flex-shrink-0 mt-0.5" />
                                <span><strong>Why Your Strengths Work Together</strong> - your unique combination</span>
                              </li>
                              <li className="flex items-start gap-3">
                                <Check className="w-5 h-5 text-green-500 flex-shrink-0 mt-0.5" />
                                <span><strong>5-7 Role Territories to Explore</strong> with salary ranges and search terms</span>
                              </li>
                              <li className="flex items-start gap-3">
                                <Check className="w-5 h-5 text-green-500 flex-shrink-0 mt-0.5" />
                                <span><strong>Next Steps</strong> - concrete actions for this week, month, and 90 days</span>
                              </li>
                              <li className="flex items-start gap-3">
                                <Check className="w-5 h-5 text-green-500 flex-shrink-0 mt-0.5" />
                                <span><strong>Professional PDF Report</strong> you can reference and share</span>
                              </li>
                            </ul>
                          </div>
                          ...
                          <button
                            onClick={async () => {
                              try {
                                ...
                                alert('Payment system not configured yet. Check DEPLOYMENT-GUIDE.md');
                              }
                            }}
                            className="bg-gradient-to-r from-pink-500 via-orange-500 to-amber-500 hover:shadow-2xl text-white px-12 py-5 rounded-full text-lg font-semibold transition-all shadow-xl inline-flex items-center gap-3"
                          >
                          ...
                          <p className="text-xs text-gray-500 mt-6">
                            ...
                            <a href="/terms" className="underline hover:text-gray-700 ml-1">Terms of Service</a>
                          </p>
                        </div>
                      </>
                    )}

                    {/* PAID: Show all content */}
                    {paymentCompleted && (
                      <>
                        {/* Show remaining 3 superpowers */}
                        {parsedData.superpowers.slice(1).map((power, idx) => (
                          <div 
                            key={idx + 1}
              ...
              {synthesisScreen === 3 && parsedData?.territories && paymentCompleted && (
                <div className="space-y-8 animate-fade-in">
                  <div className="text-center mb-8">
              ...
              {synthesisScreen === 4 && parsedData?.nextSteps && paymentCompleted && (
                <div className="space-y-8 animate-fade-in">
                  <div className="text-center mb-8">
